ALTER TABLE CUSTOMER ALTER EMAIL TYPE char(60)#
ALTER TABLE BINCOMPANY ALTER EMAIL TYPE char(60)#
ALTER TABLE CUSTOMERSITE ALTER EMAIL TYPE char(60)#
ALTER TABLE RGSALESORDER ALTER EMAIL TYPE char(60)#
ALTER TABLE SALESMAN ALTER EMAIL TYPE char(60)#
ALTER TABLE SORDER ALTER EMAIL TYPE char(60)#
...
CREATE OR ALTER PROCEDURE MYGET_BINCOMPANIES
RETURNS (
...
CREATE OR ALTER PROCEDURE MYGET_BINMOVEMENTS (
    IPDATEFROM DATE,
    IPDATETO DATE)
RETURNS (
    OPCBINNO VARCHAR(10),
...
CREATE OR ALTER PROCEDURE MYGET_CRMCONTACTS (
...
CREATE OR ALTER PROCEDURE MYGET_CRMCUSTSFORSM (
...
CREATE OR ALTER PROCEDURE MYGET_CRMNEWCUSTS (
    IPSALESMANID INTEGER,
    IPFROMDATE DATE,
    IPTODATE DATE)
RETURNS (
...
CREATE OR ALTER PROCEDURE MYGET_CRMNOORDERS (
    IPSALESMANID INTEGER,
    IPFROMDATE DATE,
    IPTODATE DATE)
RETURNS (
...
CREATE OR ALTER PROCEDURE MYGET_CUSTBYNAME (
    IPNAME CHAR(50),
...
CREATE OR ALTER PROCEDURE MYGET_CUSTHISTBASIC (
    IPCUSTID INTEGER)
RETURNS (
    OPJOBDATE DATE,
...
CREATE OR ALTER PROCEDURE MYGET_CUSTINVOICES (
    IPCUSTID INTEGER,
    IPJUSTOPEN INTEGER)
RETURNS (
    OPINVINVNO INTEGER,
...
CREATE OR ALTER PROCEDURE MYGET_CUSTOMER (
    IPCUSTID INTEGER)
RETURNS (
    OPCSTCUSTID INTEGER,
    OPCSTNAME CHAR(50),
...
CREATE OR ALTER PROCEDURE MYGET_CUSTOMERS (
    IPWHATTYPE INTEGER,
...
CREATE OR ALTER PROCEDURE MYGET_CUSTOMERS2 (
    IPWHATTYPE INTEGER,
    IPJUSTLATEST INTEGER)
RETURNS (
    OPCSTCUSTID INTEGER,
...
CREATE OR ALTER PROCEDURE MYGET_CUSTRGPICKUPS (
    IPCUSTID INTEGER,
    IPDELTYPE INTEGER)
RETURNS (
    OPRGSOID INTEGER,
...
CREATE OR ALTER PROCEDURE MYGET_CUSTRGPUDATE (
    IPCUSTID INTEGER,
    IPDELTYPE INTEGER,
    IPFROMDATE DATE)
RETURNS (
...
CREATE OR ALTER PROCEDURE MYGET_CUSTSJOBSFROMTO (
    IPCUSTID INTEGER,
...
CREATE OR ALTER PROCEDURE MYGET_CUSTSOPENJOBS (
    IPCUSTID INTEGER)
RETURNS (
    OPJOBJOBID INTEGER,
    OPJOBJOBTYPE INTEGER,
...
CREATE OR ALTER PROCEDURE MYGET_CUSTSOPENTIPS (
    IPCUSTID INTEGER)
RETURNS (
    OPTIPID INTEGER,
    OPTIPDDATE DATE,
...
CREATE OR ALTER PROCEDURE MYGET_CUSTSTIPS (
    IPCUSTID INTEGER,
    IPFROMDATE DATE,
    IPTODATE DATE)
RETURNS (
...
CREATE OR ALTER PROCEDURE MYGET_DOCKET (
...
CREATE OR ALTER PROCEDURE MYGET_DOCKETS (
    IPFORDATE DATE)
RETURNS (
    OPDOCKETID INTEGER,
    OPDOCKETNO INTEGER,
...
CREATE OR ALTER PROCEDURE MYGET_DOCKETSADDR (
    IPFORCUSTID INTEGER)
RETURNS (
    OPADDRID INTEGER,
    OPSTREETNUMBER CHAR(10),
...
CREATE OR ALTER PROCEDURE MYGET_DOCKETSCUST (
    IPFORCUSTID INTEGER)
RETURNS (
    OPDOCKETID INTEGER,
    OPDOCKETNO INTEGER,
...
CREATE OR ALTER PROCEDURE MYGET_INVOICE (
...
CREATE OR ALTER PROCEDURE MYGET_INVOICES (
...
CREATE OR ALTER PROCEDURE MYGET_JOB (
    IPJOBID INTEGER = 0)
RETURNS (
    OPJOBJOBID INTEGER,
    OPJOBJOBTYPE INTEGER,
...
CREATE OR ALTER PROCEDURE MYGET_JOBPAYDETAILSONDATE (
    IPFORDATE DATE = null)
RETURNS (
    OPJOBJOBID INTEGER,
    OPJOBJOBTYPE INTEGER,
...
CREATE OR ALTER PROCEDURE MYGET_JOBSFROMTO (
...
CREATE OR ALTER PROCEDURE MYGET_JOBSFROMTODD (
    IPFROMDD INTEGER,
    IPTODD INTEGER)
RETURNS (
    OPJOBJOBID INTEGER,
...
CREATE OR ALTER PROCEDURE MYGET_JOBSONDATE (
    IPDATE DATE)
RETURNS (
    OPJOBJOBID INTEGER,
    OPJOBJOBTYPE INTEGER,
...
CREATE OR ALTER PROCEDURE MYGET_JOBSONDATEFORDRIVER (
    IPDATE DATE,
    IPDRIVERID INTEGER)
RETURNS (
    OPJOBJOBID INTEGER,
...
CREATE OR ALTER PROCEDURE MYGET_OPENORDERANDJOBS
RETURNS (
    OPORDORDERID INTEGER,
    OPORDCONTACT CHAR(30),
    OPORDCOMPLETE INTEGER,
...
CREATE OR ALTER PROCEDURE MYGET_ORDERANDJOBS (
    IPORDERID INTEGER = null)
RETURNS (
    OPORDORDERID INTEGER,
    OPORDCONTACT CHAR(30),
...
CREATE OR ALTER PROCEDURE MYGET_ORDERJOBS (
...
CREATE OR ALTER PROCEDURE MYGET_ORDERSONWKNO (
...
CREATE OR ALTER PROCEDURE MYGET_PAYDETAILS (
...
CREATE OR ALTER PROCEDURE MYGET_PINVOICE (
...
CREATE OR ALTER PROCEDURE MYGET_RGORDER (
...
CREATE OR ALTER PROCEDURE MYGET_RGORDERBYINV (
    IPINVNO INTEGER DEFAULT NULL,
...
CREATE OR ALTER PROCEDURE MYGET_RGORDERFORDATE (
    IPFORDATE DATE DEFAULT NULL,
...
CREATE OR ALTER PROCEDURE MYGET_RGPICKUPS (
    IPDELTYPE INTEGER)
RETURNS (
    OPRGSOID INTEGER,
    OPCUSTID INTEGER,
...
CREATE OR ALTER PROCEDURE MYGET_SEARCHFOR (
    IPCUSTREF CHAR(100),
    IPDESPATCH CHAR(30),
    IPINVNO INTEGER,
    IPCOMMENTS CHAR(30),
...
CREATE OR ALTER PROCEDURE MYGET_SWPREVORDERS (
    IPCUSTID INTEGER,
    IPDEPOTNO CHAR(12))
RETURNS (
    OPORDERID INTEGER,
...
CREATE OR ALTER PROCEDURE MYGET_TIP (
    IPTIPID INTEGER)
RETURNS (
    OPTIPID INTEGER,
    OPTIPDDATE DATE,
...
CREATE OR ALTER PROCEDURE MYGET_TIPBYINV (
    IPINVNO INTEGER,
    IPINVLINENO INTEGER)
RETURNS (
    OPTIPID INTEGER,
...
CREATE OR ALTER PROCEDURE MYGET_TIPS (
    IPDDATE DATE,
    IPTIPSITEID INTEGER)
RETURNS (
    OPTIPID INTEGER,
...
CREATE OR ALTER PROCEDURE MYGET_TIPSFROMTO (
    IPFROMDATE DATE,
    IPTODATE DATE)
RETURNS (
    OPTIPID INTEGER,
...
CREATE OR ALTER PROCEDURE MYGET_TIPSNOTINVOICED (
    IPTIPSITEID INTEGER,
    IPINVPERIOD INTEGER)
RETURNS (
    OPTIPID INTEGER,
...
CREATE OR ALTER PROCEDURE SPADD_DRIVER (
...
CREATE OR ALTER PROCEDURE SPCALC_SITESOH
AS
BEGIN
  EXIT;
END#
...
CREATE OR ALTER PROCEDURE SPDEL_BINMV (
...
CREATE OR ALTER PROCEDURE SPDEL_BOOKINVNO (
    IPINVNO INTEGER)
AS
BEGIN
  EXIT;
...
CREATE OR ALTER PROCEDURE SPDEL_CLEARJOBFEES (
...
CREATE OR ALTER PROCEDURE SPDEL_CONTRACTDRIVERPRICE (
    IPDRIVERID INTEGER)
AS
BEGIN
  EXIT;
...
CREATE OR ALTER PROCEDURE SPDEL_COUNCILPDFS (
    IPCOUNCILID INTEGER)
AS
BEGIN
  EXIT;
...
CREATE OR ALTER PROCEDURE SPDEL_COUNCILSUBURBS (
    IPCOUNCILID INTEGER)
AS
BEGIN
  EXIT;
...
CREATE OR ALTER PROCEDURE SPDEL_CREDITNOTE (
...
CREATE OR ALTER PROCEDURE SPDEL_CUSTOMER (
    IPCUSTID INTEGER)
AS
BEGIN
  EXIT;
...
CREATE OR ALTER PROCEDURE SPDEL_CUSTSITEPRICES (
...
CREATE OR ALTER PROCEDURE SPDEL_DRIVERRECLINES (
...
CREATE OR ALTER PROCEDURE SPDEL_HOLIDAY (
    IPDAYOFF DATE)
AS
BEGIN
  EXIT;
...
CREATE OR ALTER PROCEDURE SPDEL_INVBATCH (
...
CREATE OR ALTER PROCEDURE SPDEL_INVLINE (
    IPINVNO INTEGER,
    IPINVLINENO INTEGER)
AS
BEGIN
...
CREATE OR ALTER PROCEDURE SPDEL_INVOICE (
    IPINVNO INTEGER)
AS
BEGIN
  EXIT;
...
CREATE OR ALTER PROCEDURE SPDEL_JOB (
...
CREATE OR ALTER PROCEDURE SPDEL_JOBBINS (
    IPJOBID INTEGER DEFAULT NULL)
AS
BEGIN
  EXIT;
...
CREATE OR ALTER PROCEDURE SPDEL_JOBRMBREAKDOWN (
    IPJOBID INTEGER)
AS
BEGIN
  EXIT;
...
CREATE OR ALTER PROCEDURE SPDEL_JOBSWCODE (
...
CREATE OR ALTER PROCEDURE SPDEL_ORDER (
    IPORDERID INTEGER DEFAULT NULL)
AS
BEGIN
  EXIT;
...
CREATE OR ALTER PROCEDURE SPDEL_PINVLINE (
    IPPINVID INTEGER,
    IPINVLINENO INTEGER)
AS
BEGIN
...
CREATE OR ALTER PROCEDURE SPDEL_PINVOICE (
    IPPINVID INTEGER)
AS
BEGIN
  EXIT;
...
CREATE OR ALTER PROCEDURE SPDEL_RGORDER (
    IPRGSOID INTEGER)
AS
BEGIN
  EXIT;
...
CREATE OR ALTER PROCEDURE SPDEL_SITEFOREMAN (
    IPCUSTSITEID INTEGER,
    IPFOREMANID INTEGER)
AS
BEGIN
...
CREATE OR ALTER PROCEDURE SPDEL_SMSTEMPLATE (
...
CREATE OR ALTER PROCEDURE SPDEL_STAKE_BINLINES (
...
CREATE OR ALTER PROCEDURE SPDEL_TIP (
    IPTIPID INTEGER)
AS
BEGIN
  EXIT;
...
CREATE OR ALTER PROCEDURE SPDEL_TIPFEES (
...
CREATE OR ALTER PROCEDURE SPGET_ADDRCOORDS (
    IPADDRID INTEGER)
RETURNS (
...
CREATE OR ALTER PROCEDURE SPGET_ADHOCCHARGES (
...
CREATE OR ALTER PROCEDURE SPGET_AUDITLOG (
    IPFROM TIMESTAMP,
    IPTO TIMESTAMP)
RETURNS (
...
CREATE OR ALTER PROCEDURE SPGET_AVAIL_POS_FOR_CUST_ADDR (
    IP_CUSTID INTEGER,
    IP_ADDRID INTEGER)
RETURNS (
    OP_PO VARCHAR(100))
...
CREATE OR ALTER PROCEDURE SPGET_AVAILCREDIT (
    IPCUSTID INTEGER,
...
CREATE OR ALTER PROCEDURE SPGET_BCPRICES (
...
CREATE OR ALTER PROCEDURE SPGET_BINFORMAT (
...
CREATE OR ALTER PROCEDURE SPGET_BINFORMATS
RETURNS (
    OPBINFORMATID INTEGER,
    OPDESCRIPTION CHAR(30),
    OPDEFAULTFORMAT SMALLINT,
...
CREATE OR ALTER PROCEDURE SPGET_BINMVS (
...
CREATE OR ALTER PROCEDURE SPGET_BINNOUSE (
...
CREATE OR ALTER PROCEDURE SPGET_BINSUSED (
...
CREATE OR ALTER PROCEDURE SPGET_BINTYPE (
    IPBINTYPEID INTEGER)
RETURNS (
    OPBINTYPEID INTEGER,
    OPBINTYPE CHAR(3),
...
CREATE OR ALTER PROCEDURE SPGET_BINTYPES
RETURNS (
    OPBINTYPEID INTEGER,
    OPBINTYPE CHAR(8),
...
CREATE OR ALTER PROCEDURE SPGET_BOOKINVNOS
RETURNS (
    OPINVNO INTEGER)
AS
BEGIN
...
CREATE OR ALTER PROCEDURE SPGET_CALLCOUNTS (
    IPFROMDATE DATE,
    IPTODATE DATE)
RETURNS (
    OPDDATE DATE,
...
CREATE OR ALTER PROCEDURE SPGET_CANDELETECUST (
    IPCUSTID INTEGER)
RETURNS (
    OPCANDELETE INTEGER)
AS
...
CREATE OR ALTER PROCEDURE SPGET_CARDTYPES
RETURNS (
    OPCARDTYPEID INTEGER,
    OPCARDNAME CHAR(8),
...
CREATE OR ALTER PROCEDURE SPGET_CDRPT (
    IPDRIVERID INTEGER,
...
CREATE OR ALTER PROCEDURE SPGET_CHANGEDETAILS (
    IPENTITYID INTEGER,
    IPOBJECTID INTEGER)
RETURNS (
    OPAMDTIME TIMESTAMP,
...
CREATE OR ALTER PROCEDURE SPGET_CONTRACTDRIVERPRICES (
    IPDRIVERID INTEGER)
RETURNS (
    OPDRIVERID INTEGER,
    OPJOBTYPE INTEGER,
...
CREATE OR ALTER PROCEDURE SPGET_COUNCIL (
    IPCOUNCILID INTEGER)
RETURNS (
    OPCOUNCILID INTEGER,
    OPNAME CHAR(40),
...
CREATE OR ALTER PROCEDURE SPGET_COUNCILPDFS (
    IPCOUNCILID INTEGER)
RETURNS (
    OPFILENAME CHAR(256),
    OPDESCRIPTION CHAR(50))
...
CREATE OR ALTER PROCEDURE SPGET_COUNCILS
RETURNS (
    OPCOUNCILID INTEGER,
    OPNAME CHAR(40),
    OPCOMMENT CHAR(200))
...
CREATE OR ALTER PROCEDURE SPGET_COUNCILSFORSUB (
    IPSUBURB CHAR(40),
    IPSTATE CHAR(30),
    IPPOSTCODE CHAR(10))
RETURNS (
...
CREATE OR ALTER PROCEDURE SPGET_COUNCILSUBURBS (
    IPCOUNCILID INTEGER)
RETURNS (
...
CREATE OR ALTER PROCEDURE SPGET_CREDITLINES (
    IPCREDITNOTEID INTEGER)
RETURNS (
...
CREATE OR ALTER PROCEDURE SPGET_CREDITLINESFROMTO (
    IPLINETYPE INTEGER,
    IPFROMDATE DATE,
    IPTODATE DATE)
RETURNS (
...
CREATE OR ALTER PROCEDURE SPGET_CREDITNOTE (
    IPCNID INTEGER)
RETURNS (
    OPCREDITNOTEID INTEGER,
...
CREATE OR ALTER PROCEDURE SPGET_CREDITNOTES (
    IPCUSTID INTEGER)
RETURNS (
    OPCREDITNOTEID INTEGER,
    OPCREDITNOTENO INTEGER,
...
CREATE OR ALTER PROCEDURE SPGET_CREDITNOTESFORBATCH (
    IPBATCHID INTEGER)
RETURNS (
    OPCREDITNOTEID INTEGER,
    OPCREDITNOTENO INTEGER,
...
CREATE OR ALTER PROCEDURE SPGET_CREDITNOTESFORINVNO (
    IPINVNO CHAR(10))
RETURNS (
    OPCREDITNOTEID INTEGER,
    OPCREDITNOTENO INTEGER,
...
CREATE OR ALTER PROCEDURE SPGET_CREDITNOTESFROMTO (
    IPFROMDATE DATE,
    IPTODATE DATE)
RETURNS (
    OPCREDITNOTEID INTEGER,
...
CREATE OR ALTER PROCEDURE SPGET_CRMCOMMSMETHOD
RETURNS (
...
CREATE OR ALTER PROCEDURE SPGET_CURRENTBINLEVELS
RETURNS (
    OPBINTYPEID INTEGER,
    OPSITEID INTEGER,
    OPBINCOUNT INTEGER)
...
CREATE OR ALTER PROCEDURE SPGET_CUSTGROUPS (
    IPCUSTID INTEGER,
    IPGROUPID INTEGER)
RETURNS (
    OPCUSTID INTEGER,
...
CREATE OR ALTER PROCEDURE SPGET_CUSTHIST (
...
CREATE OR ALTER PROCEDURE SPGET_CUSTOMERSITES (
    IPCUSTID INTEGER,
    IPJUSTOPEN INTEGER)
RETURNS (
...
CREATE OR ALTER PROCEDURE SPGET_CUSTOPENORDERS (
    IPCUSTID INTEGER,
    IPMAXSITES INTEGER)
RETURNS (
    OPORDERID INTEGER,
...
CREATE OR ALTER PROCEDURE SPGET_CUSTRGPRICES (
    IPCUSTID INTEGER)
RETURNS (
    OPRGID INTEGER,
...
CREATE OR ALTER PROCEDURE SPGET_CUSTS1STJOBID (
    IPCUSTID INTEGER,
    IPFROMDATE DATE)
RETURNS (
    OPJOBID INTEGER,
...
CREATE OR ALTER PROCEDURE SPGET_CUSTSITEPRICES (
...
CREATE OR ALTER PROCEDURE SPGET_DEPTS
RETURNS (
    OPDEPTID INTEGER,
    OPDEPTDESC CHAR(40),
...
CREATE OR ALTER PROCEDURE SPGET_DRIVER (
    IPDRIVERID SMALLINT)
RETURNS (
    OPDRIVERID SMALLINT,
    OPSHORTNAME CHAR(8),
...
CREATE OR ALTER PROCEDURE SPGET_DRIVERANAL (
    IPFROMDATE DATE,
    IPTODATE DATE)
RETURNS (
    OPDRIVERID INTEGER,
...
CREATE OR ALTER PROCEDURE SPGET_DRIVERLOGWEB (
    IPDDATE DATE,
    IPDRIVERID INTEGER)
RETURNS (
    OPSTARTTIME TIMESTAMP,
...
CREATE OR ALTER PROCEDURE SPGET_DRIVERREC (
    IPDDATE DATE,
    IPDRIVERID INTEGER)
RETURNS (
    OPBATCHID INTEGER,
...
CREATE OR ALTER PROCEDURE SPGET_DRIVERS
RETURNS (
    OPDRIVERID SMALLINT,
    OPSHORTNAME CHAR(8),
    OPFULLNAME CHAR(25),
...
CREATE OR ALTER PROCEDURE SPGET_EVENTTIME (
...
CREATE OR ALTER PROCEDURE SPGET_EXTCOMMENTS (
...
CREATE OR ALTER PROCEDURE SPGET_FEE (
...
CREATE OR ALTER PROCEDURE SPGET_FEES
RETURNS (
    OPFEEID INTEGER,
    OPDESCRIPTION CHAR(20),
    OPAMOUNT DECIMAL(12,2),
...
CREATE OR ALTER PROCEDURE SPGET_FTBINSINOUT (
    IPSTARTDATE DATE DEFAULT NULL,
    IPENDDATE DATE DEFAULT NULL)
RETURNS (
    OPBINTYPEID INTEGER,
...
CREATE OR ALTER PROCEDURE SPGET_FTBINSINOUT_DAILY (
    IPSTARTDATE DATE DEFAULT NULL,
    IPENDDATE DATE DEFAULT NULL)
RETURNS (
    OPBINTYPEID INTEGER,
...
CREATE OR ALTER PROCEDURE SPGET_HOLIDAYS
RETURNS (
    DAYOFF DATE)
AS
BEGIN
...
CREATE OR ALTER PROCEDURE SPGET_HOURSWORKED (
    IPJOBID INTEGER)
RETURNS (
...
CREATE OR ALTER PROCEDURE SPGET_INCLUDEDWEIGHTS (
...
CREATE OR ALTER PROCEDURE SPGET_INVBATCH (
...
CREATE OR ALTER PROCEDURE SPGET_INVBATCHS (
...
CREATE OR ALTER PROCEDURE SPGET_INVLINECOMMENT (
    IPJOBID INTEGER)
RETURNS (
    OPCOMMENT CHAR(201))
AS
...
CREATE OR ALTER PROCEDURE SPGET_INVLINES (
...
CREATE OR ALTER PROCEDURE SPGET_INVOICE (
    IPINVNO INTEGER DEFAULT NULL)
RETURNS (
    OPINVNO INTEGER,
    OPINVBATCHNO INTEGER,
...
CREATE OR ALTER PROCEDURE SPGET_INVSINBATCH (
...
CREATE OR ALTER PROCEDURE SPGET_INVSUMM (
...
CREATE OR ALTER PROCEDURE SPGET_JOB (
    IPJOBID INTEGER)
RETURNS (
    OPORDERID INTEGER,
    OPJOBID INTEGER,
...
CREATE OR ALTER PROCEDURE SPGET_JOB2 (
    IPJOBID INTEGER)
RETURNS (
    OPJOBID INTEGER,
    OPPINVNO INTEGER,
...
CREATE OR ALTER PROCEDURE SPGET_JOBBINNOS (
    IPJOBID INTEGER DEFAULT NULL,
...
CREATE OR ALTER PROCEDURE SPGET_JOBDETAILS (
    IPJOBID INTEGER DEFAULT NULL)
RETURNS (
...
CREATE OR ALTER PROCEDURE SPGET_JOBFEEBYINV (
    IPINVNO INTEGER DEFAULT NULL,
    IPINVLINENO INTEGER DEFAULT NULL)
RETURNS (
    OPFEEID INTEGER,
...
CREATE OR ALTER PROCEDURE SPGET_JOBFEES (
    IPJOBID INTEGER DEFAULT NULL)
RETURNS (
    OPFEEID INTEGER,
    OPAMOUNT DECIMAL(12,2),
...
CREATE OR ALTER PROCEDURE SPGET_JOBIDBYINV (
    IPINVNO INTEGER = null,
...
CREATE OR ALTER PROCEDURE SPGET_JOBIDBYINV2 (
    IPINVNO INTEGER,
    IPINVLINENO INTEGER)
RETURNS (
    OPJOBID INTEGER)
...
CREATE OR ALTER PROCEDURE SPGET_JOBRMBREAKDOWN (
    IPJOBID INTEGER)
RETURNS (
    OPJOBID INTEGER,
    OPRGID INTEGER,
...
CREATE OR ALTER PROCEDURE SPGET_JOBSWCODES (
    IPJOBID INTEGER)
RETURNS (
...
CREATE OR ALTER PROCEDURE SPGET_JOBTIPDOCKETS (
    IPJOBID INTEGER)
RETURNS (
...
CREATE OR ALTER PROCEDURE SPGET_LASTADDRS (
    IPCUSTID INTEGER)
RETURNS (
    OPADDRID INTEGER,
    OPSTREETNUMBER CHAR(10),
...
CREATE OR ALTER PROCEDURE SPGET_LASTTRUCK (
...
CREATE OR ALTER PROCEDURE SPGET_LOGINCHECK (
...
CREATE OR ALTER PROCEDURE SPGET_MAP
RETURNS (
    OPID INTEGER,
...
CREATE OR ALTER PROCEDURE SPGET_MATCHADDRS (
...
CREATE OR ALTER PROCEDURE SPGET_MATCHCUSTS (
...
CREATE OR ALTER PROCEDURE SPGET_MATCHSTREETS (
...
CREATE OR ALTER PROCEDURE SPGET_MATCHSUBS (
...
CREATE OR ALTER PROCEDURE SPGET_MATCHSUPPS (
    IPTEXT VARCHAR(50) = null,
    IPROWS INTEGER = null,
    IPWHATTYPE INTEGER = null)
RETURNS (
...
CREATE OR ALTER PROCEDURE SPGET_MATERIALPRICES (
    IPTIPSITEID INTEGER,
    IPCUSTID INTEGER)
RETURNS (
    OPTIPSITEID INTEGER,
...
CREATE OR ALTER PROCEDURE SPGET_MATERIALS
RETURNS (
    OPID INTEGER,
...
CREATE OR ALTER PROCEDURE SPGET_MATERIALSUMM (
    IPFROMDATE DATE DEFAULT NULL,
    IPTODATE DATE DEFAULT NULL,
...
CREATE OR ALTER PROCEDURE SPGET_MLIST (
    IPMLISTID INTEGER)
RETURNS (
    OPID INTEGER,
    OPLISTID INTEGER,
...
CREATE OR ALTER PROCEDURE SPGET_MODULESETTINGS (
    IPMODULE INTEGER)
RETURNS (
    OPSETTINGS BIGINT)
AS
...
CREATE OR ALTER PROCEDURE SPGET_MONEYCOLLECTEDDAYWEB (
    IPFORDATE DATE,
    IPDRIVERID INTEGER)
RETURNS (
    OPJOBID INTEGER,
...
CREATE OR ALTER PROCEDURE SPGET_MONEYCOLLECTEDWEB (
    IPJOBID INTEGER)
RETURNS (
    OPJOBID INTEGER,
    OPPAYMETHODID1 INTEGER,
...
CREATE OR ALTER PROCEDURE SPGET_MORECOMMENTS (
...
CREATE OR ALTER PROCEDURE SPGET_MULTIDAYRUNSHEETJOBS (
...
CREATE OR ALTER PROCEDURE SPGET_MULTIDAYRUNSHEETS
RETURNS (
    OPID INTEGER,
    OPCREATEDON DATE,
    OPRUNNAME CHAR(50),
...
CREATE OR ALTER PROCEDURE SPGET_NEWSCRAPLOADID (
    IPHOWMANY INTEGER)
RETURNS (
    OPSTARTID INTEGER)
AS
...
CREATE OR ALTER PROCEDURE SPGET_NEXTCREDITNO
RETURNS (
    OPCREDITNO INTEGER)
AS
BEGIN
...
CREATE OR ALTER PROCEDURE SPGET_NEXTDDNO
RETURNS (
    OPDDNO INTEGER)
AS
BEGIN
...
CREATE OR ALTER PROCEDURE SPGET_NEXTOUTGOINGDKTNO
RETURNS (
    OPDDNO INTEGER)
AS
BEGIN
...
CREATE OR ALTER PROCEDURE SPGET_NEXTSCRAPDDNO
RETURNS (
    OPDDNO INTEGER)
AS
BEGIN
...
CREATE OR ALTER PROCEDURE SPGET_NOORDERFROMTO (
    IPFROMDATE DATE,
    IPTODATE DATE)
RETURNS (
    OPID INTEGER,
...
CREATE OR ALTER PROCEDURE SPGET_OPENORDERS
RETURNS (
    OPORDERID INTEGER,
    OPCUSTID INTEGER,
    OPCUSTNAME CHAR(50),
...
CREATE OR ALTER PROCEDURE SPGET_ORDER (
    IPORDERID INTEGER = null)
RETURNS (
    OPORDERID INTEGER,
    OPCUSTID INTEGER,
...
CREATE OR ALTER PROCEDURE SPGET_ORDERWEEKS (
    IPWKNO INTEGER DEFAULT NULL)
RETURNS (
    OPORDERID INTEGER)
AS
...
CREATE OR ALTER PROCEDURE SPGET_PAYMETHOD (
...
CREATE OR ALTER PROCEDURE SPGET_PAYMETHODS
RETURNS (
    OPPAYMETHODID SMALLINT,
    OPDESCRIPTION CHAR(6),
    OPACCT SMALLINT,
...
CREATE OR ALTER PROCEDURE SPGET_PINVBATCH (
...
CREATE OR ALTER PROCEDURE SPGET_PINVBATCHS (
    IPWHICHBATCHES INTEGER,
    IPFROMDATE DATE,
    IPTODATE DATE)
RETURNS (
...
CREATE OR ALTER PROCEDURE SPGET_PINVLINES (
...
CREATE OR ALTER PROCEDURE SPGET_PINVSFORCUSTID (
    IPCUSTID INTEGER = null)
RETURNS (
    OPPINVID INTEGER)
AS
...
CREATE OR ALTER PROCEDURE SPGET_PINVSINBATCH (
    IPINVBATCHNO INTEGER = null)
RETURNS (
    OPINVOICENO INTEGER)
AS
...
CREATE OR ALTER PROCEDURE SPGET_PRICE (
    IPCUSTID INTEGER DEFAULT NULL,
...
CREATE OR ALTER PROCEDURE SPGET_PRICEAREA (
...
CREATE OR ALTER PROCEDURE SPGET_PRICEAREAS
RETURNS (
    OPPRICEAREAID INTEGER,
    OPDESCRIPTION CHAR(30),
    OPDEFAULTAREA INTEGER,
...
CREATE OR ALTER PROCEDURE SPGET_PRICES (
    IPCUSTID INTEGER DEFAULT NULL)
RETURNS (
    OPCUSTID INTEGER,
    OPPRICEAREAID INTEGER,
...
CREATE OR ALTER PROCEDURE SPGET_PRICESFORWS (
    IPCUSTID INTEGER)
RETURNS (
    OPCUSTID INTEGER,
    OPPRICEAREAID INTEGER,
...
CREATE OR ALTER PROCEDURE SPGET_READDDNO
RETURNS (
    OPDDNO INTEGER)
AS
BEGIN
...
CREATE OR ALTER PROCEDURE SPGET_READFLDDNO
RETURNS (
    OPFLDDNO INTEGER)
AS
BEGIN
...
CREATE OR ALTER PROCEDURE SPGET_READINVNO
RETURNS (
    OPINVNO INTEGER)
AS
BEGIN
...
CREATE OR ALTER PROCEDURE SPGET_READOUTGOINGDKTNO
RETURNS (
    OPDDNO INTEGER)
AS
BEGIN
...
CREATE OR ALTER PROCEDURE SPGET_READPINVNO
RETURNS (
    OPPINVNO INTEGER)
AS
BEGIN
...
CREATE OR ALTER PROCEDURE SPGET_READTIPDDNO (
    IPTIPDDSEQ INTEGER)
RETURNS (
    OPTIPDDNO INTEGER)
AS
...
CREATE OR ALTER PROCEDURE SPGET_READYTOINVOICE (
...
CREATE OR ALTER PROCEDURE SPGET_RECONFORDAY (
    IPDDATE DATE DEFAULT NULL)
RETURNS (
    OPDRIVERID INTEGER,
    OPBATCHID INTEGER,
...
CREATE OR ALTER PROCEDURE SPGET_RECYCLEDGOODS
RETURNS (
    OPRGID INTEGER,
    OPDESCRIPTION CHAR(40),
...
CREATE OR ALTER PROCEDURE SPGET_REFERRAL (
...
CREATE OR ALTER PROCEDURE SPGET_REFERRALS
RETURNS (
    OPREFERRALID INTEGER,
    OPDESCRIPTION CHAR(20),
    OPVERSIONNO INTEGER)
...
CREATE OR ALTER PROCEDURE SPGET_REFERSUMM (
    IPSTARTDATE DATE DEFAULT NULL,
    IPENDDATE DATE DEFAULT NULL)
RETURNS (
    LRID INTEGER,
...
CREATE OR ALTER PROCEDURE SPGET_REPORTNO
RETURNS (
    OPREPORTNO INTEGER)
AS
BEGIN
...
CREATE OR ALTER PROCEDURE SPGET_RGORDERFROMTO (
    IPFROMDATE DATE,
    IPTODATE DATE)
RETURNS (
    OPRGSOID INTEGER,
...
CREATE OR ALTER PROCEDURE SPGET_RGSORDER (
    IPCUSTID INTEGER,
    IPJUSTOPEN SMALLINT)
RETURNS (
    OPRGSOID INTEGER,
...
CREATE OR ALTER PROCEDURE SPGET_RMBREAKDOWN (
    IPFROMDATE DATE,
    IPTODATE DATE,
    IPORDERID INTEGER)
RETURNS (
...
CREATE OR ALTER PROCEDURE SPGET_RMGROUPS
RETURNS (
    OPRMGROUPID INTEGER,
    OPDESCRIPTION CHAR(40),
    OPSHORTDESC CHAR(60),
...
CREATE OR ALTER PROCEDURE SPGET_RMJOBBREAKDOWN (
    IPFROMDATE DATE,
    IPTODATE DATE,
    IPCUSTID INTEGER,
    IPCUSTSITEID INTEGER)
...
CREATE OR ALTER PROCEDURE SPGET_SALESMEN
RETURNS (
    OPSALESMANID INTEGER,
    OPNAME CHAR(40),
    OPTELEPHONE CHAR(12),
...
CREATE OR ALTER PROCEDURE SPGET_SALESSUMMBT (
...
CREATE OR ALTER PROCEDURE SPGET_SALESSUMMCUST (
    IPSUMMTYPE INTEGER = null,
    IPFROMDATE DATE = null,
    IPTODATE DATE = null,
    IPPAYMETHODID INTEGER = null,
...
CREATE OR ALTER PROCEDURE SPGET_SALESSUMMDRIV (
    IPSUMMTYPE INTEGER = null,
    IPFROMDATE DATE = null,
    IPTODATE DATE = null,
    IPPAYMETHODID INTEGER = null,
...
CREATE OR ALTER PROCEDURE SPGET_SALESSUMMPA (
    IPSUMMTYPE INTEGER = null,
    IPFROMDATE DATE = null,
    IPTODATE DATE = null,
    IPPAYMETHODID INTEGER = null,
...
CREATE OR ALTER PROCEDURE SPGET_SALESSUMMSUB (
    IPSUMMTYPE INTEGER = null,
    IPFROMDATE DATE = null,
    IPTODATE DATE = null,
    IPPAYMETHODID INTEGER = null,
...
CREATE OR ALTER PROCEDURE SPGET_SCRAPBATCHNO (
    IPDATE DATE = null)
RETURNS (
    OPBATCHNO INTEGER)
AS
...
CREATE OR ALTER PROCEDURE SPGET_SITE (
...
CREATE OR ALTER PROCEDURE SPGET_SITEBINBYINV (
    IPINVNO INTEGER,
    IPINVLINENO INTEGER)
RETURNS (
    OPJOBID INTEGER,
...
CREATE OR ALTER PROCEDURE SPGET_SITEBINORDERS (
    IPFROMDATE DATE)
RETURNS (
    OPORDERID INTEGER)
AS
...
CREATE OR ALTER PROCEDURE SPGET_SITEBINSLASTINVOICE (
    IPJOBID INTEGER)
RETURNS (
    OPLASTINVDATE DATE)
AS
...
CREATE OR ALTER PROCEDURE SPGET_SITEFOREMAN (
...
CREATE OR ALTER PROCEDURE SPGET_SITES
RETURNS (
    OPSITEID INTEGER,
    OPDESCRIPTION CHAR(20),
    OPTIPSITE SMALLINT,
...
CREATE OR ALTER PROCEDURE SPGET_SITESOH (
...
CREATE OR ALTER PROCEDURE SPGET_SMSFROMTO (
    IPFROMDATE DATE,
    IPTODATE DATE)
RETURNS (
    OPSMSTYPE INTEGER,
...
CREATE OR ALTER PROCEDURE SPGET_SMSFROMTOCOUNT (
    IPFROMDATE DATE,
    IPTODATE DATE)
RETURNS (
    OPCOUNT INTEGER)
...
CREATE OR ALTER PROCEDURE SPGET_SMSS (
...
CREATE OR ALTER PROCEDURE SPGET_SMSTEMPLATES
RETURNS (
    OPID INTEGER,
...
CREATE OR ALTER PROCEDURE SPGET_STAFFACTIVITY (
    IPFROMDATE DATE,
    IPTODATE DATE)
RETURNS (
    OPUSERID INTEGER,
...
CREATE OR ALTER PROCEDURE SPGET_STAKE_BIN_DATES
RETURNS (
    OPSDATE DATE,
    OPCOMMENT CHAR(40))
AS
...
CREATE OR ALTER PROCEDURE SPGET_STAKEFINDCURRENT (
    IPDATE DATE DEFAULT NULL)
RETURNS (
    OPDATE DATE)
AS
...
CREATE OR ALTER PROCEDURE SPGET_STOCKTAKE_BINTYPE_LINES (
    IPDATE DATE DEFAULT NULL)
RETURNS (
    OPBINTYPEID INTEGER,
    OPSITEID INTEGER,
...
CREATE OR ALTER PROCEDURE SPGET_STOCKTAKE_FROMTO (
    IPFROMDATE DATE DEFAULT NULL,
    IPTODATE DATE DEFAULT NULL)
RETURNS (
    OPSTAKEDATE DATE,
...
CREATE OR ALTER PROCEDURE SPGET_STREETCOORDS (
    IPSTREETID INTEGER)
RETURNS (
    OPPAGENUMBER INTEGER,
    OPMAPREF CHAR(5))
...
CREATE OR ALTER PROCEDURE SPGET_STREETSMATCHING (
    IPSTATE CHAR(30),
    IPSUBURB CHAR(40),
    IPPOSTCODE CHAR(10),
...
CREATE OR ALTER PROCEDURE SPGET_SUBURB (
...
CREATE OR ALTER PROCEDURE SPGET_SUBURBSBYPCODE (
...
CREATE OR ALTER PROCEDURE SPGET_SUBURBSBYSTATE (
    IPSTATE VARCHAR(30) CHARACTER SET ASCII)
RETURNS (
    OPSUBURB VARCHAR(40) CHARACTER SET ASCII,
    OPPOSTCODE VARCHAR(5) CHARACTER SET ASCII,
...
CREATE OR ALTER PROCEDURE SPGET_SWCODES
RETURNS (
    OPSWCODEID INTEGER,
    OPSWCODENO CHAR(10),
...
CREATE OR ALTER PROCEDURE SPGET_SWORDERBYJOBID (
    IPJOBID INTEGER)
RETURNS (
    OPSWORDERID INTEGER,
    OPREQUESTDATE DATE,
...
CREATE OR ALTER PROCEDURE SPGET_SYSFLAG (
...
CREATE OR ALTER PROCEDURE SPGET_SYSFLAGS
RETURNS (
    OPDATA CHAR(140))
AS
BEGIN
...
CREATE OR ALTER PROCEDURE SPGET_TAREWT (
    IPREGO CHAR(20))
RETURNS (
    OPREGO CHAR(20),
...
CREATE OR ALTER PROCEDURE SPGET_TERM (
...
CREATE OR ALTER PROCEDURE SPGET_TERMS
RETURNS (
    OPTERMSID INTEGER,
    OPDESCRIPTION CHAR(20))
AS
...
CREATE OR ALTER PROCEDURE SPGET_TEST
RETURNS (
    ID INTEGER,
    OCUSTID INTEGER,
    OJOBID INTEGER,
...
CREATE OR ALTER PROCEDURE SPGET_TIPBATCHNO (
    IPDATE DATE = null,
...
CREATE OR ALTER PROCEDURE SPGET_TIPFEEBYINV (
    IPINVNO INTEGER DEFAULT NULL,
    IPINVLINENO INTEGER DEFAULT NULL)
RETURNS (
    OPTFID INTEGER,
...
CREATE OR ALTER PROCEDURE SPGET_TIPFEES (
    IPTIPID INTEGER DEFAULT NULL)
RETURNS (
    OPTFID INTEGER,
    OPTIPID INTEGER,
...
CREATE OR ALTER PROCEDURE SPGET_TIPNEXTDDNO (
...
CREATE OR ALTER PROCEDURE SPGET_TIPREGOS (
    IPCUSTID INTEGER,
    IPFROMDATE DATE)
RETURNS (
    OPREGO CHAR(20),
...
CREATE OR ALTER PROCEDURE SPGET_TIPSITES
RETURNS (
    OPTIPSITEID INTEGER,
    OPDESCRIPTION CHAR(40),
    OPRULES CHAR(1000),
...
CREATE OR ALTER PROCEDURE SPGET_TRUCK (
...
CREATE OR ALTER PROCEDURE SPGET_TRUCKANDDOGSFROMTO (
    IPFROMDATE DATE,
    IPTODATE DATE)
RETURNS (
...
CREATE OR ALTER PROCEDURE SPGET_TRUCKANDDOGSONDAY2 (
    IPFORDATE DATE)
RETURNS (
    OPTRUCKANDDOGID INTEGER,
    OPJOBDATE DATE,
...
CREATE OR ALTER PROCEDURE SPGET_TRUCKDRIVERS (
    IPDDATE DATE = null)
RETURNS (
    OPDDATE DATE,
    OPDRIVERID INTEGER,
...
CREATE OR ALTER PROCEDURE SPGET_TRUCKS
RETURNS (
    OPTRUCKID INTEGER,
    OPDESCRIPTION CHAR(12) CHARACTER SET ASCII,
    OPVEHICLEID CHAR(12))
...
CREATE OR ALTER PROCEDURE SPGET_UNAVAIL_POS_FOR_CUST_ADDR (
    IP_CUSTID INTEGER,
    IP_ADDRID INTEGER)
RETURNS (
    OP_PO VARCHAR(100))
...
CREATE OR ALTER PROCEDURE SPGET_USERS
RETURNS (
    OPUSERID INTEGER,
    OPUSERNAME CHAR(50),
    OPFULLNAME CHAR(50),
...
CREATE OR ALTER PROCEDURE SPGET_VOLPICKEDUP (
    IPFROMDATE DATE,
    IPTODATE DATE)
RETURNS (
    OPDATE DATE,
...
CREATE OR ALTER PROCEDURE SPSAVE_ADDRFIND (
    IPORDERID INTEGER,
    IPSUBURB CHAR(30),
    IPSTREETNAME CHAR(30),
    IPSTREETNUMBER CHAR(10),
...
CREATE OR ALTER PROCEDURE SPSAVE_ADHOCCHARGE (
    IPADHOCCHARGEID INTEGER,
    IPCUSTID INTEGER,
    IPJOBID INTEGER,
    IPFEEID INTEGER,
...
CREATE OR ALTER PROCEDURE SPSAVE_ADHOCINVSTATE (
    IPADHOCCHARGEID INTEGER,
    IPINVSTATE INTEGER)
AS
BEGIN
...
CREATE OR ALTER PROCEDURE SPSAVE_BCPRICE (
    IPBINCOMPANYID INTEGER,
    IPBINTYPEID INTEGER,
...
CREATE OR ALTER PROCEDURE SPSAVE_BINCOMPANY (
    IPBINCOMPANYID INTEGER,
...
CREATE OR ALTER PROCEDURE SPSAVE_BINFORMAT (
    IPBINFORMATID INTEGER DEFAULT NULL,
...
CREATE OR ALTER PROCEDURE SPSAVE_BINMV (
    IPBINMVID INTEGER DEFAULT NULL,
    IPMVDATE DATE DEFAULT NULL,
    IPBINTYPEID INTEGER DEFAULT NULL,
...
CREATE OR ALTER PROCEDURE SPSAVE_BINTYPE (
    IPBINTYPEID INTEGER,
    IPBINTYPE CHAR(8),
...
CREATE OR ALTER PROCEDURE SPSAVE_BOOKINVNO (
    IPINVNO INTEGER)
AS
BEGIN
  EXIT;
...
CREATE OR ALTER PROCEDURE SPSAVE_CALLCOUNTS (
    IPDDATE DATE,
    IPUSERID INTEGER,
    IPNEWORDERS INTEGER,
...
CREATE OR ALTER PROCEDURE SPSAVE_CARDTYPE (
...
CREATE OR ALTER PROCEDURE SPSAVE_CHANGEDETAILS (
    IPENTITYID INTEGER,
    IPOBJECTID INTEGER,
    IPAMDTIME TIMESTAMP,
    IPDETAILS CHAR(500),
...
CREATE OR ALTER PROCEDURE SPSAVE_COMMSMETHOD (
...
CREATE OR ALTER PROCEDURE SPSAVE_CONTACTDETAILS (
...
CREATE OR ALTER PROCEDURE SPSAVE_CONTRACTDRIVERPRICES (
    IPDRIVERID INTEGER,
    IPJOBTYPE INTEGER,
    IPBINTYPEID INTEGER,
...
CREATE OR ALTER PROCEDURE SPSAVE_COUNCIL (
    IPCOUNCILID INTEGER,
    IPNAME CHAR(40),
    IPCOMMENT CHAR(200))
RETURNS (
...
CREATE OR ALTER PROCEDURE SPSAVE_COUNCILPDF (
    IPCOUNCILID INTEGER,
    IPFILENAME CHAR(256),
    IPDESCRIPTION CHAR(50))
AS
...
CREATE OR ALTER PROCEDURE SPSAVE_COUNCILSUBURB (
    IPCOUNCILID INTEGER,
...
CREATE OR ALTER PROCEDURE SPSAVE_CREDITNOTE (
    IPCREDITNOTEID INTEGER,
...
CREATE OR ALTER PROCEDURE SPSAVE_CREDITNOTELINE (
...
CREATE OR ALTER PROCEDURE SPSAVE_CRMCONTACT (
    IPCONTACTID INTEGER,
    IPCUSTID INTEGER,
...
CREATE OR ALTER PROCEDURE SPSAVE_CUSTGROUP (
    IPCUSTID INTEGER,
    IPGROUPID INTEGER,
    IPINFO CHAR(50),
    IPADD INTEGER)
...
CREATE OR ALTER PROCEDURE SPSAVE_CUSTLASTPA (
    IPCUSTID INTEGER DEFAULT NULL,
...
CREATE OR ALTER PROCEDURE SPSAVE_CUSTOMER (
    IPCUSTID INTEGER,
    IPNAME CHAR(50),
    IPTELEPHONE CHAR(14),
    IPADDRID INTEGER,
...
CREATE OR ALTER PROCEDURE SPSAVE_CUSTOMERPAYALLOCATION (
    IPID INTEGER,
...
CREATE OR ALTER PROCEDURE SPSAVE_CUSTOMERPAYMENT (
    IPID INTEGER,
    IPCUSTID INTEGER,
    IPPAYMENTDATE DATE,
...
CREATE OR ALTER PROCEDURE SPSAVE_CUSTOMERSITE (
    IPCUSTSITEID INTEGER,
    IPDESCRIPTION CHAR(50),
    IPCONTACT CHAR(50),
    IPPHONE CHAR(30),
...
CREATE OR ALTER PROCEDURE SPSAVE_CUSTREGO (
...
CREATE OR ALTER PROCEDURE SPSAVE_CUSTRGPRICE (
    IPCUSTID INTEGER,
    IPRGID INTEGER,
...
CREATE OR ALTER PROCEDURE SPSAVE_CUSTSALESMAN (
    IPCUSTID INTEGER,
    IPSALESMANID INTEGER,
...
CREATE OR ALTER PROCEDURE SPSAVE_CUSTSITEPRICE (
    IPCUSTSITEID INTEGER,
    IPBINTYPEID INTEGER,
    IPPRICE DECIMAL(9,2),
    IPINCEX INTEGER)
...
CREATE OR ALTER PROCEDURE SPSAVE_DCKSAVEDOCKET (
    IPDOCKETID INTEGER,
    IPDOCKETNO INTEGER,
    IPCUSTID INTEGER,
...
CREATE OR ALTER PROCEDURE SPSAVE_DEDUCTION (
...
CREATE OR ALTER PROCEDURE SPSAVE_DEDUCTIONITEM (
...
CREATE OR ALTER PROCEDURE SPSAVE_DEPT (
    IPDEPTID INTEGER,
    IPDEPTDESC CHAR(40),
...
CREATE OR ALTER PROCEDURE SPSAVE_DRIVER (
    IPDRIVERID SMALLINT,
    IPSHORTNAME CHAR(8),
    IPFULLNAME CHAR(25),
    IPSTARTDATE DATE,
...
CREATE OR ALTER PROCEDURE SPSAVE_DRIVERLOGWEB (
    IPDRIVERID INTEGER,
    IPFORDATE DATE,
    IPREGO CHAR(15),
    IPSTARTKMS INTEGER,
...
CREATE OR ALTER PROCEDURE SPSAVE_DRIVERRECBATCH (
    IPBATCHID INTEGER,
    IPDDATE DATE,
    IPDRIVERID INTEGER,
...
CREATE OR ALTER PROCEDURE SPSAVE_DRIVERRECBATCHBAL (
    IPBATCHID INTEGER DEFAULT NULL,
...
CREATE OR ALTER PROCEDURE SPSAVE_DRIVERRECLINE (
...
CREATE OR ALTER PROCEDURE SPSAVE_EMAILLOG (
...
CREATE OR ALTER PROCEDURE SPSAVE_EXTCOMMENT (
    IPID INTEGER,
    IPNEXTID INTEGER,
    IPCOMMENTTYPE INTEGER,
    IPCOMMENT CHAR(200))
...
CREATE OR ALTER PROCEDURE SPSAVE_FEE (
    IPFEEID INTEGER DEFAULT NULL,
...
CREATE OR ALTER PROCEDURE SPSAVE_HOLIDAY (
    IPDAYOFF DATE)
AS
BEGIN
  EXIT;
...
CREATE OR ALTER PROCEDURE SPSAVE_HOURSWORKED (
...
CREATE OR ALTER PROCEDURE SPSAVE_INCLUDEDWEIGHT (
    IPPRICEAREAID INTEGER,
    IPBINTYPEID INTEGER,
...
CREATE OR ALTER PROCEDURE SPSAVE_INVBATCH (
    IPINVBATCH INTEGER DEFAULT NULL,
...
CREATE OR ALTER PROCEDURE SPSAVE_INVCOMMENTS (
    IPINVNO INTEGER DEFAULT NULL,
...
CREATE OR ALTER PROCEDURE SPSAVE_INVITEMCODE (
    IPINVNO INTEGER DEFAULT NULL,
...
CREATE OR ALTER PROCEDURE SPSAVE_INVLINE (
    IPINVNO INTEGER = null,
...
CREATE OR ALTER PROCEDURE SPSAVE_INVLINECHG (
    IPINVNO INTEGER DEFAULT NULL,
    IPINVLINENO INTEGER DEFAULT NULL,
...
CREATE OR ALTER PROCEDURE SPSAVE_INVLINECOMMENT (
    IPJOBID INTEGER,
    IPCOMMENT CHAR(201),
    IPINVNO INTEGER,
    IPINVLINENO INTEGER)
...
CREATE OR ALTER PROCEDURE SPSAVE_INVOICE (
    IPINVBATCH INTEGER = null,
    IPCUSTID INTEGER = null,
    IPINVDATE DATE = null,
    IPDUEDATE DATE = null,
...
CREATE OR ALTER PROCEDURE SPSAVE_INVOICECHG (
    IPINVNO INTEGER DEFAULT NULL,
...
CREATE OR ALTER PROCEDURE SPSAVE_INVOICEPAIDDETS (
    IPINVNO INTEGER,
...
CREATE OR ALTER PROCEDURE SPSAVE_JOB (
    IPJOBID INTEGER,
    IPJOBDATE DATE,
    IPORDERID INTEGER,
...
CREATE OR ALTER PROCEDURE SPSAVE_JOB2GPS (
    IPJOBID INTEGER,
    IPIMGNUMBER INTEGER,
    IPLAT DECIMAL(11,6),
    IPLONG DECIMAL(11,6))
...
CREATE OR ALTER PROCEDURE SPSAVE_JOB2INVVALS (
    IPJOBID INTEGER,
...
CREATE OR ALTER PROCEDURE SPSAVE_JOB2PHOTOTIME (
    IPJOBID INTEGER,
    IPIMGNUMBER INTEGER,
    IPCOMMENT CHAR(100),
...
CREATE OR ALTER PROCEDURE SPSAVE_JOB2WEB (
    IPJOBID INTEGER,
...
CREATE OR ALTER PROCEDURE SPSAVE_JOBBINCOMPANY (
    IPJOBID INTEGER,
    IPBINCOMPANYID INTEGER,
    IPBUYPRICE INTEGER,
...
CREATE OR ALTER PROCEDURE SPSAVE_JOBBINNOS (
    IPJOBID INTEGER = null,
...
CREATE OR ALTER PROCEDURE SPSAVE_JOBDD (
    IPJOBID INTEGER = null,
...
CREATE OR ALTER PROCEDURE SPSAVE_JOBDDEMAIL (
    IPJOBID INTEGER,
    IPDDEMAIL CHAR(60))
AS
BEGIN
...
CREATE OR ALTER PROCEDURE SPSAVE_JOBDONEWEB (
    IPJOBID INTEGER,
    IPNEWSTATUS INTEGER)
AS
BEGIN
...
CREATE OR ALTER PROCEDURE SPSAVE_JOBDRIVER (
    IPJOBID INTEGER = null,
...
CREATE OR ALTER PROCEDURE SPSAVE_JOBEPAWTD (
    IPJOBID INTEGER,
    IPEPA CHAR(12),
    IPWTD CHAR(12))
AS
...
CREATE OR ALTER PROCEDURE SPSAVE_JOBEVENTTIMES (
    IPID INTEGER,
    IPEVENTTYPE INTEGER,
...
CREATE OR ALTER PROCEDURE SPSAVE_JOBFEE (
    IPJOBID INTEGER = null,
    IPFEEID INTEGER = null,
...
CREATE OR ALTER PROCEDURE SPSAVE_JOBINVOICEABLE (
    IPJOBID INTEGER DEFAULT NULL,
...
CREATE OR ALTER PROCEDURE SPSAVE_JOBMV (
    IPJOBID INTEGER DEFAULT NULL,
...
CREATE OR ALTER PROCEDURE SPSAVE_JOBPAYDETAILS (
    IPDOJOBID INTEGER,
    IPPAYDETID INTEGER,
    IPPAYMETHODID INTEGER,
    IPREFERENCE CHAR(40),
...
CREATE OR ALTER PROCEDURE SPSAVE_JOBPAYMETHOD (
    IPJOBID INTEGER = null,
...
CREATE OR ALTER PROCEDURE SPSAVE_JOBPUINVOICEABLE (
    IPJOBID INTEGER,
    IPINVOICEME INTEGER)
AS
BEGIN
...
CREATE OR ALTER PROCEDURE SPSAVE_JOBPUWEIGHT (
    IPJOBID INTEGER,
    IPPUWEIGHT DECIMAL(5,3),
    IPINVOICEME INTEGER,
    IPSITEID INTEGER,
...
CREATE OR ALTER PROCEDURE SPSAVE_JOBRMBREAKDOWN (
    IPJOBID INTEGER,
    IPRMGROUPID INTEGER,
    IPPERCENT INTEGER)
AS
...
CREATE OR ALTER PROCEDURE SPSAVE_JOBSENTTODEVICE (
    IPJOBID INTEGER)
AS
BEGIN
  EXIT;
...
CREATE OR ALTER PROCEDURE SPSAVE_JOBSTATUS (
    IPJOBID INTEGER = null,
...
CREATE OR ALTER PROCEDURE SPSAVE_JOBSWCODE (
    IPJOBSWCODEID INTEGER,
    IPJOBID INTEGER,
    IPSWCODESID INTEGER,
...
CREATE OR ALTER PROCEDURE SPSAVE_JOBTIPDOCKET (
...
CREATE OR ALTER PROCEDURE SPSAVE_JOBWEB (
    IPJOBID INTEGER,
    IPDD CHAR(12),
    IPDOBINNOS CHAR(60),
    IPFROMSITEID INTEGER,
...
CREATE OR ALTER PROCEDURE SPSAVE_JOBWHENTOINVOICE (
    IPDOJOBID INTEGER,
    IPPUJOBID INTEGER,
    IPWHENTOINVOICE INTEGER)
AS
...
CREATE OR ALTER PROCEDURE SPSAVE_LOADEDINVOICE (
    IPINVBATCH INTEGER DEFAULT NULL,
    IPINVNO INTEGER DEFAULT NULL,
    IPCUSTID INTEGER DEFAULT NULL,
...
CREATE OR ALTER PROCEDURE SPSAVE_LOADINVBATCH (
    IPINVBATCH INTEGER DEFAULT NULL,
    IPCREATEDDATE TIMESTAMP DEFAULT NULL,
    IPEXPORTEDDATE TIMESTAMP DEFAULT NULL,
    IPFILENAME CHAR(50) DEFAULT NULL,
...
CREATE OR ALTER PROCEDURE SPSAVE_MARKTIPASOKAYED (
    IPTIPID INTEGER,
...
CREATE OR ALTER PROCEDURE SPSAVE_MATERIAL (
    IPID INTEGER = null,
...
CREATE OR ALTER PROCEDURE SPSAVE_MATERIALPRICE (
    IPTIPSITEID INTEGER,
    IPCUSTID INTEGER,
    IPMATERIALID INTEGER,
...
CREATE OR ALTER PROCEDURE SPSAVE_MATERIALPRICE_PERM3 (
    IPTIPSITEID INTEGER,
    IPCUSTID INTEGER,
    IPMATERIALID INTEGER,
...
CREATE OR ALTER PROCEDURE SPSAVE_MATERIALPRICE_PERTON (
    IPTIPSITEID INTEGER,
    IPCUSTID INTEGER,
    IPMATERIALID INTEGER,
...
CREATE OR ALTER PROCEDURE SPSAVE_MLIST (
    IPID INTEGER,
    IPMLISTID INTEGER,
    IPDESC CHAR(50),
    IPDESC2 CHAR(50),
...
CREATE OR ALTER PROCEDURE SPSAVE_MODULESETTINGS (
    IPMODULE INTEGER,
    IPSETTINGS BIGINT)
AS
BEGIN
...
CREATE OR ALTER PROCEDURE SPSAVE_MONEYCOLLECTEDEMAIL (
    IPJOBID INTEGER,
    IPEMAILADDR CHAR(60))
AS
BEGIN
...
CREATE OR ALTER PROCEDURE SPSAVE_MONEYCOLLECTEDWEB (
    IPJOBID INTEGER,
...
CREATE OR ALTER PROCEDURE SPSAVE_MORECOMMENTS (
...
CREATE OR ALTER PROCEDURE SPSAVE_MULTIDAYRUNSHEET (
    IPID INTEGER,
    IPCREATEDON DATE,
    IPRUNNAME CHAR(50),
    IPDRIVERID INTEGER,
...
CREATE OR ALTER PROCEDURE SPSAVE_MULTIDAYRUNSHEETJOB (
    IPRUNSHEETID INTEGER,
    IPSORTORDER INTEGER,
    IPJOBID INTEGER)
RETURNS (
...
CREATE OR ALTER PROCEDURE SPSAVE_NEWDDNO (
    IPNEWDDNO INTEGER)
AS
BEGIN
  EXIT;
...
CREATE OR ALTER PROCEDURE SPSAVE_NEWFLDDNO (
    IPNEWFLDDNO INTEGER)
AS
BEGIN
  EXIT;
...
CREATE OR ALTER PROCEDURE SPSAVE_NEWINVNO (
...
CREATE OR ALTER PROCEDURE SPSAVE_NEWOUTGOINGDKTNO (
    IPNEWDDNO INTEGER)
AS
BEGIN
  EXIT;
...
CREATE OR ALTER PROCEDURE SPSAVE_NEWPINVNO (
...
CREATE OR ALTER PROCEDURE SPSAVE_NEWTIPDDNO (
...
CREATE OR ALTER PROCEDURE SPSAVE_NOORDER (
    IPID INTEGER,
    IPDDATE DATE,
    IPTTIME TIMESTAMP,
    IPUSERID INTEGER,
...
CREATE OR ALTER PROCEDURE SPSAVE_ORDER (
    IPORDERID INTEGER,
    IPCUSTID INTEGER,
    IPINVTYPE INTEGER,
    IPBYBINNO INTEGER,
...
CREATE OR ALTER PROCEDURE SPSAVE_ORDERPLACEDBY (
    IPJOBID INTEGER,
    IPPLACEDBY CHAR(30),
    IPENTITYID INTEGER,
    IPUSERID INTEGER)
...
CREATE OR ALTER PROCEDURE SPSAVE_PAYMETHOD (
    IPPAYMETHODID INTEGER,
...
CREATE OR ALTER PROCEDURE SPSAVE_PINVBATCH (
    IPINVBATCH INTEGER = null,
...
CREATE OR ALTER PROCEDURE SPSAVE_PINVLINE (
    IPPINVID INTEGER = null,
    IPLINENO INTEGER = null,
    IPEXGSTVALUE DECIMAL(18,2) = null,
    IPGST DECIMAL(18,2) = null,
...
CREATE OR ALTER PROCEDURE SPSAVE_PINVOICE (
    IPINVBATCH INTEGER = null,
    IPCUSTID INTEGER = null,
    IPINVDATE DATE = null,
    IPDUEDATE DATE = null,
...
CREATE OR ALTER PROCEDURE SPSAVE_PRICE (
    IPCUSTID INTEGER DEFAULT NULL,
    IPPRICEAREAID INTEGER DEFAULT NULL,
    IPBINTYPEID INTEGER DEFAULT NULL,
...
CREATE OR ALTER PROCEDURE SPSAVE_PRICEAREA (
    IPPRICEAREAID INTEGER,
    IPDESCRIPTION CHAR(30),
...
CREATE OR ALTER PROCEDURE SPSAVE_RECYCLEDGOOD (
    IPRGID INTEGER,
...
CREATE OR ALTER PROCEDURE SPSAVE_REFERRAL (
...
CREATE OR ALTER PROCEDURE SPSAVE_RGROORDER (
    IPORDERID INTEGER,
    IPRGSOID INTEGER)
AS
BEGIN
...
CREATE OR ALTER PROCEDURE SPSAVE_RGSORDER (
    IPRGSOID INTEGER,
    IPORDERNO INTEGER,
    IPCUSTID INTEGER,
    IPRGID INTEGER,
...
CREATE OR ALTER PROCEDURE SPSAVE_RMGROUP (
    IPID INTEGER,
    IPDESCRIPTION CHAR(40),
    IPSHORTDESC CHAR(60),
...
CREATE OR ALTER PROCEDURE SPSAVE_SALESMAN (
    IPSALESMANID INTEGER,
    IPNAME CHAR(40),
    IPTELEPHONE CHAR(12),
    IPEMAIL CHAR(60),
...
CREATE OR ALTER PROCEDURE SPSAVE_SITE (
    IPSITEID INTEGER = null,
...
CREATE OR ALTER PROCEDURE SPSAVE_SITEBININVOICE (
    IPJOBID INTEGER,
    IPFROMDATE DATE,
    IPTODATE DATE,
    IPBINTYPEID INTEGER,
...
CREATE OR ALTER PROCEDURE SPSAVE_SITEFOREMAN (
    IPCUSTSITEID INTEGER,
    IPFOREMANID INTEGER,
    IPNAME CHAR(40),
...
CREATE OR ALTER PROCEDURE SPSAVE_SMS (
...
CREATE OR ALTER PROCEDURE SPSAVE_SMSCOUNT (
    IPFORDATE DATE,
    IPMSGCOUNT INTEGER)
AS
BEGIN
...
CREATE OR ALTER PROCEDURE SPSAVE_SMSTEMPLATE (
    IPID INTEGER DEFAULT NULL,
...
CREATE OR ALTER PROCEDURE SPSAVE_STAKE_BINLINE (
    IPDATE DATE DEFAULT NULL,
    IPBINTYPEID INTEGER DEFAULT NULL,
...
CREATE OR ALTER PROCEDURE SPSAVE_STAKE_BINTYPE (
    IPDATE DATE DEFAULT NULL,
...
CREATE OR ALTER PROCEDURE SPSAVE_STREET (
    IPSTREETID INTEGER,
...
CREATE OR ALTER PROCEDURE SPSAVE_SUBURB (
...
CREATE OR ALTER PROCEDURE SPSAVE_SWCODE (
    IPSWCODEID INTEGER,
    IPSWCODENO CHAR(12),
...
CREATE OR ALTER PROCEDURE SPSAVE_SWORDER (
    IPSWORDERID INTEGER,
    IPREQUESTDATE DATE,
...
CREATE OR ALTER PROCEDURE SPSAVE_SYSDATA (
    IPSUBJECT INTEGER,
    IPDATA CHAR(200),
    IPDTIME TIMESTAMP)
AS
...
CREATE OR ALTER PROCEDURE SPSAVE_SYSFLAG (
    IPSUBJECT CHAR(25) DEFAULT NULL,
...
CREATE OR ALTER PROCEDURE SPSAVE_TAREWT (
    IPREGO CHAR(20),
...
CREATE OR ALTER PROCEDURE SPSAVE_TIP (
    IPTIPID INTEGER,
    IPDDATE DATE,
    IPTIMEIN TIMESTAMP,
    IPTIMEOUT TIMESTAMP,
...
CREATE OR ALTER PROCEDURE SPSAVE_TIPFEE (
    IPID INTEGER DEFAULT NULL,
    IPFEEID INTEGER DEFAULT NULL,
    IPTIPID INTEGER DEFAULT NULL,
...
CREATE OR ALTER PROCEDURE SPSAVE_TIPOUTGOING (
...
CREATE OR ALTER PROCEDURE SPSAVE_TIPSITE (
    IPID INTEGER,
    IPDESCRIPTION CHAR(40),
    IPRULES CHAR(1000),
...
CREATE OR ALTER PROCEDURE SPSAVE_TRUCK (
    IPID INTEGER = null,
...
CREATE OR ALTER PROCEDURE SPSAVE_TRUCKANDDOG2 (
...
CREATE OR ALTER PROCEDURE SPSAVE_TRUCKDRIVER (
    IPDDATE DATE DEFAULT NULL,
    IPDRIVERID INTEGER DEFAULT NULL,
...
CREATE OR ALTER PROCEDURE SPSAVE_USER (
    IPUSERID INTEGER,
    IPUSERNAME CHAR(50),
    IPFULLNAME CHAR(50),
    IPISACTIVE SMALLINT,
...
CREATE OR ALTER PROCEDURE SPSAVE_WSSESSION (
    IPSESSIONID INTEGER,
    IPDRIVERID INTEGER,
...
CREATE OR ALTER PROCEDURE SPSAVE_WSTEXT (
    IPWSTEXTID INTEGER,
...
CREATE OR ALTER PROCEDURE SPSAVE_XVERSIONNO (
    IPVERSIONNO INTEGER)
AS
BEGIN
  EXIT;
...
CREATE OR ALTER PROCEDURE SPSET_EVENT (
...
CREATE OR ALTER PROCEDURE SPSET_JOBBINS (
    IPJOBID INTEGER DEFAULT NULL)
AS
BEGIN
  EXIT;
...
CREATE OR ALTER PROCEDURE TESTSPEED
RETURNS (
    LCOUNT INTEGER)
AS
BEGIN
...
CREATE OR ALTER PROCEDURE UPD_EVENT (
    IPEVENT CHAR(20) DEFAULT NULL)
AS
BEGIN
  EXIT;
...
CREATE OR ALTER PROCEDURE ADJUSTSITESOH (
    IPBINTYPEID INTEGER = null,
    IPSITEID INTEGER = null,
